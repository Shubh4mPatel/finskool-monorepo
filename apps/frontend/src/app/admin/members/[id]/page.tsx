    ...
    <div className="flex flex-col gap-6">
      <div className="relative">
        <button
          ...
          className="absolute left-4 top-8 z-10 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-full bg-black/15 text-white transition-colors hover:bg-black/25"
        >
          <ArrowLeft size={16} />
        </button>
